...
CREATE TRIGGER tr_insere_vencedor_MelhorDocumentario AFTER INSERT ON MelhorDocumentario
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
...
CREATE TRIGGER tr_insere_vencedor_MelhorCurtaMetragem AFTER INSERT ON MelhorCurtaMetragem
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
...
CREATE TRIGGER tr_insere_vencedor_MelhorCançãoOriginal AFTER INSERT ON MelhorCançãoOriginal
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
...
CREATE TRIGGER tr_insere_vencedor_MelhorMaquiagemEPenteados AFTER INSERT ON MelhorMaquiagemEPenteados
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
...
CREATE TRIGGER tr_insere_vencedor_MelhorDirecaoDeArte AFTER INSERT ON MelhorDirecaoDeArte
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
...
CREATE TRIGGER tr_insere_vencedor_MelhoresEfeitosVisuais AFTER INSERT ON MelhoresEfeitosVisuais
FOR EACH ROW
BEGIN
    DECLARE v_vencedor_nome VARCHAR(255);
    DECLARE v_vencedor_votos INT;
